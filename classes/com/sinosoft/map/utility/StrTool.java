...
public class StrTool
{
	...
	{
		String strReturn = (new StringBuilder(String.valueOf(getVisaYear(strDate)))).append("年").append(getVisaMonth(strDate)).append("月").append(getVisaDay(strDate)).append("日").toString();
		return strReturn;
	}
