...
// Source File Name:   XMLDatasetP.java
...
//			CErrors, FileViewer, XMLDataObject, Schema, 
//			SchemaSet, CError
...
public class XMLDatasetP
{
	...
	public boolean createFileListName(String FilePath)
	{
		...
		Element elementRow;
		Element elementName;
		for (; f.nextFile(); elementRow.addContent(elementName.addContent(f.getFileName())))
		{
			elementRow = new Element("row");
	...
	public Object clone()
	{
		if (_Element == null)
			...
			return new XMLDatasetP(getElement());
	}
