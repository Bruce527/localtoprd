...
// Source File Name:   MC2BMessageBSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MC2BMessageBSchema cloned = (MC2BMessageBSchema)super.clone();
	...
	{
		iD = aMC2BMessageBSchema.getID();
		manageCom = aMC2BMessageBSchema.getManageCom();
		branchType = aMC2BMessageBSchema.getBranchType();
		message = aMC2BMessageBSchema.getMessage();
		messageType = aMC2BMessageBSchema.getMessageType();
		keyData = aMC2BMessageBSchema.getKeyData();
		keyData2 = aMC2BMessageBSchema.getKeyData2();
		keyData3 = aMC2BMessageBSchema.getKeyData3();
		keyData4 = aMC2BMessageBSchema.getKeyData4();
		uRL = aMC2BMessageBSchema.getURL();
		type = aMC2BMessageBSchema.getType();
		state = aMC2BMessageBSchema.getState();
		startDate = fDate.getDate(aMC2BMessageBSchema.getStartDate());
		endDate = fDate.getDate(aMC2BMessageBSchema.getEndDate());
		startTime = aMC2BMessageBSchema.getStartTime();
		endTime = aMC2BMessageBSchema.getEndTime();
		vF01 = aMC2BMessageBSchema.getVF01();
		nF01 = aMC2BMessageBSchema.getNF01();
		iF01 = aMC2BMessageBSchema.getIF01();
		dF02 = aMC2BMessageBSchema.getDF02();
		date01 = fDate.getDate(aMC2BMessageBSchema.getDate01());
		operator = aMC2BMessageBSchema.getOperator();
		makeDate = fDate.getDate(aMC2BMessageBSchema.getMakeDate());
		makeTime = aMC2BMessageBSchema.getMakeTime();
		edorNo = aMC2BMessageBSchema.getEdorNo();
		edorType = aMC2BMessageBSchema.getEdorType();
		edorCase = aMC2BMessageBSchema.getEdorCase();
		operator2 = aMC2BMessageBSchema.getOperator2();
		makeDate2 = fDate.getDate(aMC2BMessageBSchema.getMakeDate2());
		makeTime2 = aMC2BMessageBSchema.getMakeTime2();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MC2BMessageB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MC2BMessageBSchema";
	...
	{
		MC2BMessageBSchema aMC2BMessageBSchema = new MC2BMessageBSchema();
		aMC2BMessageBSchema.setSchema(this);
		return aMC2BMessageBSchema;
	}

	public MC2BMessageBDB getDB()
	{
		MC2BMessageBDB aDBOper = new MC2BMessageBDB();
	...
	public boolean decode(String strMessage)
	{
		try
		{
			...
			edorNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, "|");
			edorType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, "|");
			edorCase = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, "|");
			operator2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, "|");
			makeDate2 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, "|"));
			makeTime2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, "|");
		}
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MC2BMessageBSchema other = (MC2BMessageBSchema)otherObject;
	...
	public int getFieldIndex(String strFieldName)
	{
		...
		if (strFieldName.equals("makeDate2"))
			return 28;
		return !strFieldName.equals("makeTime2") ? -1 : 29;
	}
