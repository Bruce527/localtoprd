...
// Source File Name:   MUserLoginLogSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MUserLoginLogSchema cloned = (MUserLoginLogSchema)super.clone();
	...
	{
		iD = aMUserLoginLogSchema.getID();
		userCode = aMUserLoginLogSchema.getUserCode();
		userType = aMUserLoginLogSchema.getUserType();
		clientName = aMUserLoginLogSchema.getClientName();
		clientType = aMUserLoginLogSchema.getClientType();
		clientIP = aMUserLoginLogSchema.getClientIP();
		loginDate = fDate.getDate(aMUserLoginLogSchema.getLoginDate());
		loginTime = aMUserLoginLogSchema.getLoginTime();
		logoutDate = fDate.getDate(aMUserLoginLogSchema.getLogoutDate());
		logoutTime = aMUserLoginLogSchema.getLogoutTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MUserLoginLog表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MUserLoginLogSchema";
	...
	{
		MUserLoginLogSchema aMUserLoginLogSchema = new MUserLoginLogSchema();
		aMUserLoginLogSchema.setSchema(this);
		return aMUserLoginLogSchema;
	}

	public MUserLoginLogDB getDB()
	{
		MUserLoginLogDB aDBOper = new MUserLoginLogDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MUserLoginLogSchema other = (MUserLoginLogSchema)otherObject;
