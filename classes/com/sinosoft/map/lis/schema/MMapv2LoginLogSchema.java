...
// Source File Name:   MMapv2LoginLogSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MMapv2LoginLogSchema cloned = (MMapv2LoginLogSchema)super.clone();
	...
	{
		iD = aMMapv2LoginLogSchema.getID();
		userCode = aMMapv2LoginLogSchema.getUserCode();
		userType = aMMapv2LoginLogSchema.getUserType();
		clientName = aMMapv2LoginLogSchema.getClientName();
		clientType = aMMapv2LoginLogSchema.getClientType();
		clientIP = aMMapv2LoginLogSchema.getClientIP();
		loginDate = fDate.getDate(aMMapv2LoginLogSchema.getLoginDate());
		loginTime = aMMapv2LoginLogSchema.getLoginTime();
		logoutDate = fDate.getDate(aMMapv2LoginLogSchema.getLogoutDate());
		logoutTime = aMMapv2LoginLogSchema.getLogoutTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MMapv2LoginLog表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MMapv2LoginLogSchema";
	...
	{
		MMapv2LoginLogSchema aMMapv2LoginLogSchema = new MMapv2LoginLogSchema();
		aMMapv2LoginLogSchema.setSchema(this);
		return aMMapv2LoginLogSchema;
	}

	public MMapv2LoginLogDB getDB()
	{
		MMapv2LoginLogDB aDBOper = new MMapv2LoginLogDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MMapv2LoginLogSchema other = (MMapv2LoginLogSchema)otherObject;
