...
// Source File Name:   MRoleInfoSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MRoleInfoSchema cloned = (MRoleInfoSchema)super.clone();
	...
	{
		iD = aMRoleInfoSchema.getID();
		roleCode = aMRoleInfoSchema.getRoleCode();
		name = aMRoleInfoSchema.getName();
		parent = aMRoleInfoSchema.getParent();
		describe = aMRoleInfoSchema.getDescribe();
		roleState = aMRoleInfoSchema.getRoleState();
		operator = aMRoleInfoSchema.getOperator();
		makeDate = fDate.getDate(aMRoleInfoSchema.getMakeDate());
		makeTime = aMRoleInfoSchema.getMakeTime();
		modifyDate = fDate.getDate(aMRoleInfoSchema.getModifyDate());
		modifyTime = aMRoleInfoSchema.getModifyTime();
		int1 = aMRoleInfoSchema.getInt1();
		int2 = aMRoleInfoSchema.getInt2();
		varc1 = aMRoleInfoSchema.getVarc1();
		varc2 = aMRoleInfoSchema.getVarc2();
		varc3 = aMRoleInfoSchema.getVarc3();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MRoleInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MRoleInfoSchema";
	...
	{
		MRoleInfoSchema aMRoleInfoSchema = new MRoleInfoSchema();
		aMRoleInfoSchema.setSchema(this);
		return aMRoleInfoSchema;
	}

	public MRoleInfoDB getDB()
	{
		MRoleInfoDB aDBOper = new MRoleInfoDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MRoleInfoSchema other = (MRoleInfoSchema)otherObject;
	...
	public int getFieldIndex(String strFieldName)
	{
		...
		if (strFieldName.equals("varc2"))
			return 14;
		return !strFieldName.equals("varc3") ? -1 : 15;
	}
