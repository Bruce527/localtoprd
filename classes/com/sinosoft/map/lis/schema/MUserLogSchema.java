...
// Source File Name:   MUserLogSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MUserLogSchema cloned = (MUserLogSchema)super.clone();
	...
	{
		iD = aMUserLogSchema.getID();
		userCode = aMUserLogSchema.getUserCode();
		userType = aMUserLogSchema.getUserType();
		traceType = aMUserLogSchema.getTraceType();
		menuID = aMUserLogSchema.getMenuID();
		menuName = aMUserLogSchema.getMenuName();
		operation = aMUserLogSchema.getOperation();
		discription = aMUserLogSchema.getDiscription();
		cientIP = aMUserLogSchema.getCientIP();
		makeDate = fDate.getDate(aMUserLogSchema.getMakeDate());
		makeTime = aMUserLogSchema.getMakeTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MUserLog表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MUserLogSchema";
	...
	{
		MUserLogSchema aMUserLogSchema = new MUserLogSchema();
		aMUserLogSchema.setSchema(this);
		return aMUserLogSchema;
	}

	public MUserLogDB getDB()
	{
		MUserLogDB aDBOper = new MUserLogDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MUserLogSchema other = (MUserLogSchema)otherObject;
