...
// Source File Name:   MAgentLoginLogSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MAgentLoginLogSchema cloned = (MAgentLoginLogSchema)super.clone();
	...
	{
		iD = aMAgentLoginLogSchema.getID();
		agentCode = aMAgentLoginLogSchema.getAgentCode();
		userType = aMAgentLoginLogSchema.getUserType();
		clientName = aMAgentLoginLogSchema.getClientName();
		clientType = aMAgentLoginLogSchema.getClientType();
		clientIP = aMAgentLoginLogSchema.getClientIP();
		loginDate = fDate.getDate(aMAgentLoginLogSchema.getLoginDate());
		loginTime = aMAgentLoginLogSchema.getLoginTime();
		logoutDate = fDate.getDate(aMAgentLoginLogSchema.getLogoutDate());
		logoutTime = aMAgentLoginLogSchema.getLogoutTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MAgentLoginLog表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MAgentLoginLogSchema";
	...
	{
		MAgentLoginLogSchema aMAgentLoginLogSchema = new MAgentLoginLogSchema();
		aMAgentLoginLogSchema.setSchema(this);
		return aMAgentLoginLogSchema;
	}

	public MAgentLoginLogDB getDB()
	{
		MAgentLoginLogDB aDBOper = new MAgentLoginLogDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MAgentLoginLogSchema other = (MAgentLoginLogSchema)otherObject;
