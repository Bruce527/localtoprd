...
// Source File Name:   MAdminLoginLogSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MAdminLoginLogSchema cloned = (MAdminLoginLogSchema)super.clone();
	...
	{
		iD = aMAdminLoginLogSchema.getID();
		agentCode = aMAdminLoginLogSchema.getAgentCode();
		userType = aMAdminLoginLogSchema.getUserType();
		clientName = aMAdminLoginLogSchema.getClientName();
		clientType = aMAdminLoginLogSchema.getClientType();
		clientIP = aMAdminLoginLogSchema.getClientIP();
		loginDate = fDate.getDate(aMAdminLoginLogSchema.getLoginDate());
		loginTime = aMAdminLoginLogSchema.getLoginTime();
		logoutDate = fDate.getDate(aMAdminLoginLogSchema.getLogoutDate());
		logoutTime = aMAdminLoginLogSchema.getLogoutTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MAdminLoginLog表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MAdminLoginLogSchema";
	...
	{
		MAdminLoginLogSchema aMAdminLoginLogSchema = new MAdminLoginLogSchema();
		aMAdminLoginLogSchema.setSchema(this);
		return aMAdminLoginLogSchema;
	}

	public MAdminLoginLogDB getDB()
	{
		MAdminLoginLogDB aDBOper = new MAdminLoginLogDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MAdminLoginLogSchema other = (MAdminLoginLogSchema)otherObject;
