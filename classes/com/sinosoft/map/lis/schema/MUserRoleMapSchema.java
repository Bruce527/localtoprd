...
// Source File Name:   MUserRoleMapSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MUserRoleMapSchema cloned = (MUserRoleMapSchema)super.clone();
	...
	{
		iD = aMUserRoleMapSchema.getID();
		userCode = aMUserRoleMapSchema.getUserCode();
		roleID = aMUserRoleMapSchema.getRoleID();
		type = aMUserRoleMapSchema.getType();
		startDate = fDate.getDate(aMUserRoleMapSchema.getStartDate());
		endDate = fDate.getDate(aMUserRoleMapSchema.getEndDate());
		operator = aMUserRoleMapSchema.getOperator();
		makeDate = fDate.getDate(aMUserRoleMapSchema.getMakeDate());
		makeTime = aMUserRoleMapSchema.getMakeTime();
		modifyDate = fDate.getDate(aMUserRoleMapSchema.getModifyDate());
		modifyTime = aMUserRoleMapSchema.getModifyTime();
		int1 = aMUserRoleMapSchema.getInt1();
		int2 = aMUserRoleMapSchema.getInt2();
		varc1 = aMUserRoleMapSchema.getVarc1();
		varc2 = aMUserRoleMapSchema.getVarc2();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MUserRoleMap表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MUserRoleMapSchema";
	...
	{
		MUserRoleMapSchema aMUserRoleMapSchema = new MUserRoleMapSchema();
		aMUserRoleMapSchema.setSchema(this);
		return aMUserRoleMapSchema;
	}

	public MUserRoleMapDB getDB()
	{
		MUserRoleMapDB aDBOper = new MUserRoleMapDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MUserRoleMapSchema other = (MUserRoleMapSchema)otherObject;
	...
	public int getFieldIndex(String strFieldName)
	{
		...
		if (strFieldName.equals("varc1"))
			return 13;
		return !strFieldName.equals("varc2") ? -1 : 14;
	}
