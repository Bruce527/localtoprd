...
// Source File Name:   MPublicMessageBSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MPublicMessageBSchema cloned = (MPublicMessageBSchema)super.clone();
	...
	{
		edorNo = aMPublicMessageBSchema.getEdorNo();
		edorType = aMPublicMessageBSchema.getEdorType();
		edorCase = aMPublicMessageBSchema.getEdorCase();
		operator2 = aMPublicMessageBSchema.getOperator2();
		makeDate2 = fDate.getDate(aMPublicMessageBSchema.getMakeDate2());
		makeTime2 = aMPublicMessageBSchema.getMakeTime2();
		iD = aMPublicMessageBSchema.getID();
		receiveBranch = aMPublicMessageBSchema.getReceiveBranch();
		manageCom = aMPublicMessageBSchema.getManageCom();
		branchType = aMPublicMessageBSchema.getBranchType();
		message = aMPublicMessageBSchema.getMessage();
		type = aMPublicMessageBSchema.getType();
		author = aMPublicMessageBSchema.getAuthor();
		state = aMPublicMessageBSchema.getState();
		startDate = fDate.getDate(aMPublicMessageBSchema.getStartDate());
		endDate = fDate.getDate(aMPublicMessageBSchema.getEndDate());
		startTime = aMPublicMessageBSchema.getStartTime();
		endTime = aMPublicMessageBSchema.getEndTime();
		vF01 = aMPublicMessageBSchema.getVF01();
		nF01 = aMPublicMessageBSchema.getNF01();
		iF01 = aMPublicMessageBSchema.getIF01();
		dF02 = aMPublicMessageBSchema.getDF02();
		date01 = fDate.getDate(aMPublicMessageBSchema.getDate01());
		operator = aMPublicMessageBSchema.getOperator();
		modifyOperator = aMPublicMessageBSchema.getModifyOperator();
		makeDate = fDate.getDate(aMPublicMessageBSchema.getMakeDate());
		makeTime = aMPublicMessageBSchema.getMakeTime();
		modifyDate = fDate.getDate(aMPublicMessageBSchema.getModifyDate());
		modifyTime = aMPublicMessageBSchema.getModifyTime();
		checkState = aMPublicMessageBSchema.getCheckState();
		checkOperator = aMPublicMessageBSchema.getCheckOperator();
		checkReason = aMPublicMessageBSchema.getCheckReason();
		checkDate = fDate.getDate(aMPublicMessageBSchema.getCheckDate());
		checkTime = aMPublicMessageBSchema.getCheckTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MPublicMessageB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MPublicMessageBSchema";
	...
	{
		MPublicMessageBSchema aMPublicMessageBSchema = new MPublicMessageBSchema();
		aMPublicMessageBSchema.setSchema(this);
		return aMPublicMessageBSchema;
	}

	public MPublicMessageBDB getDB()
	{
		MPublicMessageBDB aDBOper = new MPublicMessageBDB();
	...
	public boolean decode(String strMessage)
	{
		try
		{
			...
			iD = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, "|");
			receiveBranch = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, "|");
			manageCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, "|");
			branchType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, "|");
			message = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, "|");
			type = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, "|");
			author = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, "|");
			...
			endDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, "|"));
			startTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, "|");
			endTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, "|");
			vF01 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, "|");
			nF01 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, "|");
			iF01 = (new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage, 21, "|")))).intValue();
			dF02 = (new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 22, "|")))).doubleValue();
			date01 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, "|"));
			...
			checkState = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, "|");
			checkOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, "|");
			checkReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, "|");
			checkDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, "|"));
			checkTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, "|");
		}
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MPublicMessageBSchema other = (MPublicMessageBSchema)otherObject;
	...
	public int getFieldIndex(String strFieldName)
	{
		...
		if (strFieldName.equals("checkDate"))
			return 32;
		return !strFieldName.equals("checkTime") ? -1 : 33;
	}
