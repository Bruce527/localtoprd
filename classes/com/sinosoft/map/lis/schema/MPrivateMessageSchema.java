...
// Source File Name:   MPrivateMessageSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MPrivateMessageSchema cloned = (MPrivateMessageSchema)super.clone();
	...
	{
		iD = aMPrivateMessageSchema.getID();
		agentCode = aMPrivateMessageSchema.getAgentCode();
		manageCom = aMPrivateMessageSchema.getManageCom();
		branchType = aMPrivateMessageSchema.getBranchType();
		message = aMPrivateMessageSchema.getMessage();
		messageType = aMPrivateMessageSchema.getMessageType();
		keyData = aMPrivateMessageSchema.getKeyData();
		keyData2 = aMPrivateMessageSchema.getKeyData2();
		keyData3 = aMPrivateMessageSchema.getKeyData3();
		keyData4 = aMPrivateMessageSchema.getKeyData4();
		uRL = aMPrivateMessageSchema.getURL();
		type = aMPrivateMessageSchema.getType();
		state = aMPrivateMessageSchema.getState();
		startDate = fDate.getDate(aMPrivateMessageSchema.getStartDate());
		endDate = fDate.getDate(aMPrivateMessageSchema.getEndDate());
		startTime = aMPrivateMessageSchema.getStartTime();
		endTime = aMPrivateMessageSchema.getEndTime();
		vF01 = aMPrivateMessageSchema.getVF01();
		nF01 = aMPrivateMessageSchema.getNF01();
		iF01 = aMPrivateMessageSchema.getIF01();
		dF02 = aMPrivateMessageSchema.getDF02();
		date01 = fDate.getDate(aMPrivateMessageSchema.getDate01());
		operator = aMPrivateMessageSchema.getOperator();
		makeDate = fDate.getDate(aMPrivateMessageSchema.getMakeDate());
		makeTime = aMPrivateMessageSchema.getMakeTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MPrivateMessage表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MPrivateMessageSchema";
	...
	{
		MPrivateMessageSchema aMPrivateMessageSchema = new MPrivateMessageSchema();
		aMPrivateMessageSchema.setSchema(this);
		return aMPrivateMessageSchema;
	}

	public MPrivateMessageDB getDB()
	{
		MPrivateMessageDB aDBOper = new MPrivateMessageDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MPrivateMessageSchema other = (MPrivateMessageSchema)otherObject;
