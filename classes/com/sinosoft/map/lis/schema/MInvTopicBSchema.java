...
// Source File Name:   MInvTopicBSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		MInvTopicBSchema cloned = (MInvTopicBSchema)super.clone();
	...
	{
		topicID = aMInvTopicBSchema.getTopicID();
		topic = aMInvTopicBSchema.getTopic();
		manageCom = aMInvTopicBSchema.getManageCom();
		branchType = aMInvTopicBSchema.getBranchType();
		depiction = aMInvTopicBSchema.getDepiction();
		author = aMInvTopicBSchema.getAuthor();
		population = aMInvTopicBSchema.getPopulation();
		startDate = fDate.getDate(aMInvTopicBSchema.getStartDate());
		endDate = fDate.getDate(aMInvTopicBSchema.getEndDate());
		invType = aMInvTopicBSchema.getInvType();
		state = aMInvTopicBSchema.getState();
		invState = aMInvTopicBSchema.getInvState();
		checkState = aMInvTopicBSchema.getCheckState();
		checkOperator = aMInvTopicBSchema.getCheckOperator();
		checkReason = aMInvTopicBSchema.getCheckReason();
		checkDate = fDate.getDate(aMInvTopicBSchema.getCheckDate());
		checkTime = aMInvTopicBSchema.getCheckTime();
		vF01 = aMInvTopicBSchema.getVF01();
		nF01 = aMInvTopicBSchema.getNF01();
		iF01 = aMInvTopicBSchema.getIF01();
		dF02 = aMInvTopicBSchema.getDF02();
		date01 = fDate.getDate(aMInvTopicBSchema.getDate01());
		modifyOperator = aMInvTopicBSchema.getModifyOperator();
		operator = aMInvTopicBSchema.getOperator();
		makeDate = fDate.getDate(aMInvTopicBSchema.getMakeDate());
		makeTime = aMInvTopicBSchema.getMakeTime();
		modifyDate = fDate.getDate(aMInvTopicBSchema.getModifyDate());
		modifyTime = aMInvTopicBSchema.getModifyTime();
		edorNo = aMInvTopicBSchema.getEdorNo();
		edorType = aMInvTopicBSchema.getEdorType();
		edorCase = aMInvTopicBSchema.getEdorCase();
		operator2 = aMInvTopicBSchema.getOperator2();
		makeDate2 = fDate.getDate(aMInvTopicBSchema.getMakeDate2());
		makeTime2 = aMInvTopicBSchema.getMakeTime2();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的MInvTopicB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "MInvTopicBSchema";
	...
	{
		MInvTopicBSchema aMInvTopicBSchema = new MInvTopicBSchema();
		aMInvTopicBSchema.setSchema(this);
		return aMInvTopicBSchema;
	}

	public MInvTopicBDB getDB()
	{
		MInvTopicBDB aDBOper = new MInvTopicBDB();
	...
	public boolean decode(String strMessage)
	{
		try
		{
			...
			edorNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, "|");
			edorType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, "|");
			edorCase = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, "|");
			operator2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, "|");
			makeDate2 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, "|"));
			makeTime2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, "|");
		}
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		MInvTopicBSchema other = (MInvTopicBSchema)otherObject;
	...
	public int getFieldIndex(String strFieldName)
	{
		...
		if (strFieldName.equals("makeDate2"))
			return 32;
		return !strFieldName.equals("makeTime2") ? -1 : 33;
	}
