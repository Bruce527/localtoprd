...
// Source File Name:   MLibraryStructBSet.java
...
public class MLibraryStructBSet extends SchemaSet
{
	...
	{
		MLibraryStructBSchema tSchema = (MLibraryStructBSchema)super.getObj(index);
		return tSchema;
	}
	...
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			MLibraryStructBSchema aSchema = get(i);
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			MLibraryStructBSchema aSchema = new MLibraryStructBSchema();
		...
		MLibraryStructBSchema tSchema = new MLibraryStructBSchema();
