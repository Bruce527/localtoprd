...
public class MComSet extends SchemaSet
{
	...
	{
		MComSchema tSchema = (MComSchema)super.getObj(index);
		return tSchema;
	}
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			MComSchema aSchema = new MComSchema();
		...
		MComSchema tSchema = new MComSchema();
