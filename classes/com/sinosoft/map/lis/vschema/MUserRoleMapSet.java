...
// Source File Name:   MUserRoleMapSet.java
...
public class MUserRoleMapSet extends SchemaSet
{
	...
	{
		MUserRoleMapSchema tSchema = (MUserRoleMapSchema)super.getObj(index);
		return tSchema;
	}
	...
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			MUserRoleMapSchema aSchema = get(i);
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			MUserRoleMapSchema aSchema = new MUserRoleMapSchema();
		...
		MUserRoleMapSchema tSchema = new MUserRoleMapSchema();
