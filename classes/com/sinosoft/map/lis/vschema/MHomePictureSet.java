...
// Source File Name:   MHomePictureSet.java
...
public class MHomePictureSet extends SchemaSet
{
	...
	{
		MHomePictureSchema tSchema = (MHomePictureSchema)super.getObj(index);
		return tSchema;
	}
	...
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			MHomePictureSchema aSchema = get(i);
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			MHomePictureSchema aSchema = new MHomePictureSchema();
		...
		MHomePictureSchema tSchema = new MHomePictureSchema();
