...
// Source File Name:   MCourseSet.java
...
public class MCourseSet extends SchemaSet
{
	...
	{
		MCourseSchema tSchema = (MCourseSchema)super.getObj(index);
		return tSchema;
	}
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			MCourseSchema aSchema = new MCourseSchema();
		...
		MCourseSchema tSchema = new MCourseSchema();
