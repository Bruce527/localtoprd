...
// Source File Name:   MInvTopicSet.java
...
public class MInvTopicSet extends SchemaSet
{
	...
	{
		MInvTopicSchema tSchema = (MInvTopicSchema)super.getObj(index);
		return tSchema;
	}
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			MInvTopicSchema aSchema = new MInvTopicSchema();
		...
		MInvTopicSchema tSchema = new MInvTopicSchema();
