...
// Source File Name:   SysMaxNoZhongYing.java
	...
	implements SysMaxNo
{
	...
	public String CreateMaxNo(String cNoType, String cNoLimit)
	{
		...
		if (cNoType.equals("PAYNOTICENO"))
			tReturn = (new StringBuilder("31")).append(tCom).toString();
		else
		...
		if (cNoType.equals("EDORAPPNO"))
			tReturn = (new StringBuilder("41")).append(tCom).toString();
		else
		if (cNoType.equals("EDORNO"))
			tReturn = (new StringBuilder("42")).append(tCom).toString();
		else
		if (cNoType.equals("EDORGRPAPPNO"))
			tReturn = (new StringBuilder("43")).append(tCom).toString();
		else
		if (cNoType.equals("EDORGRPNO"))
			tReturn = (new StringBuilder("44")).append(tCom).toString();
		else
...
label0:
	...
	{
		SysMaxNoZhongYing sysMaxNoZhongYing1 = new SysMaxNoZhongYing();
		System.out.println(sysMaxNoZhongYing1.CreateMaxNo("GRPNO", "SN"));
	}
}
