...
public class ValidateTools
{
	...
	public static String validZipCodeErrorMessage = "输入应该�?6位数�?";
	public static String validTelCode2ErrorMessage = "长度�?6-19位数�?";
	...
	public static String isValidIDNo(String aIDNo, String aBirthday, String aSex)
	{
		...
		if (aIDNo.length() == 15)
		{
			...
			if (isDate(tmpStr))
			{
				...
				{
					sReturn = "输入的生日与身份证号的信息不�?�?";
					return sReturn;
				}
			} else
			{
				sReturn = "输入身份证号中的生日日期信息不正�?";
				return sReturn;
			}
		} else
		if (aIDNo.length() == 18)
