...
public class LNPCodeList
{
	...
	public List getLoanNameList()
	{
		...
		loanNameList.add(new SelectItem(new String("其他自定�?"), "其他自定�?"));
		return loanNameList;
	}
	...
	public List getBurialType()
	{
		...
		burialType.add(new SelectItem(new String("f1"), "1�?"));
		burialType.add(new SelectItem(new String("f2"), "2�?"));
		burialType.add(new SelectItem(new String("f3"), "3�?"));
		return burialType;
	}
	...
	{
		sexList = new ArrayList();
		sexList.add(new SelectItem(new String("0"), "�?"));
		sexList.add(new SelectItem(new String("1"), "�?"));
		return sexList;
	}
	...
	public List getFeeNameList()
	{
		...
		feeNameList.add(new SelectItem(new String("保险�?"), "保险�?"));
		feeNameList.add(new SelectItem(new String("其他自定�?"), "其他自定�?"));
		return feeNameList;
	}
	...
	{
		hosRoomStageList = new ArrayList();
		hosRoomStageList.add(new SelectItem("h0", "单人�?"));
		hosRoomStageList.add(new SelectItem("h1", "多人�?"));
	...
	public List getIncomeDataList()
	{
		...
		incomeDataList.add(new SelectItem(new String("子女奉养�?"), "子女奉养�?"));
		incomeDataList.add(new SelectItem(new String("其他自定�?"), "其他自定�?"));
	...
	public List getInvestDataList()
	{
		...
		investDataList.add(new SelectItem(new String("其他自定�?"), "其他自定�?"));
	...
	public List getInsuranceList()
	{
		...
		insuranceList.add(new SelectItem(new String("1"), "养�??"));
	...
	public List getTfeeNameList()
	{
		...
		tfeeNameList.add(new SelectItem(new String("其他自定�?"), "其他自定�?"));
		return tfeeNameList;
	}
	...
	{
		payYearTypeList = new ArrayList();
		payYearTypeList.add(new SelectItem(new String("a"), "交费年期 (�?)"));
		payYearTypeList.add(new SelectItem(new String("b"), "缴至年龄 (�?)"));
