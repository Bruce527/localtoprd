...
// Source File Name:   LNPAgentTraceSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		LNPAgentTraceSchema cloned = (LNPAgentTraceSchema)super.clone();
	...
	{
		iD = aLNPAgentTraceSchema.getID();
		contno = aLNPAgentTraceSchema.getContno();
		operator = aLNPAgentTraceSchema.getOperator();
		operatorDate = fDate.getDate(aLNPAgentTraceSchema.getOperatorDate());
		operatorTime = aLNPAgentTraceSchema.getOperatorTime();
		operatorType = aLNPAgentTraceSchema.getOperatorType();
		int1 = aLNPAgentTraceSchema.getInt1();
		int2 = aLNPAgentTraceSchema.getInt2();
		varc1 = aLNPAgentTraceSchema.getVarc1();
		varc2 = aLNPAgentTraceSchema.getVarc2();
		varc5 = aLNPAgentTraceSchema.getVarc5();
		varc3 = aLNPAgentTraceSchema.getVarc3();
		varc4 = aLNPAgentTraceSchema.getVarc4();
		varc6 = aLNPAgentTraceSchema.getVarc6();
		date1 = fDate.getDate(aLNPAgentTraceSchema.getDate1());
		date2 = fDate.getDate(aLNPAgentTraceSchema.getDate2());
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的LNPAgentTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "LNPAgentTraceSchema";
	...
	{
		LNPAgentTraceSchema aLNPAgentTraceSchema = new LNPAgentTraceSchema();
		aLNPAgentTraceSchema.setSchema(this);
		return aLNPAgentTraceSchema;
	}

	public LNPAgentTraceDB getDB()
	{
		LNPAgentTraceDB aDBOper = new LNPAgentTraceDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		LNPAgentTraceSchema other = (LNPAgentTraceSchema)otherObject;
