...
// Source File Name:   LNPFAndIImpOptionSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		LNPFAndIImpOptionSchema cloned = (LNPFAndIImpOptionSchema)super.clone();
	...
	{
		impartId = aLNPFAndIImpOptionSchema.getImpartId();
		questionId = aLNPFAndIImpOptionSchema.getQuestionId();
		optionId = aLNPFAndIImpOptionSchema.getOptionId();
		optionOrder = aLNPFAndIImpOptionSchema.getOptionOrder();
		optionContent = aLNPFAndIImpOptionSchema.getOptionContent();
		operator = aLNPFAndIImpOptionSchema.getOperator();
		manageCom = aLNPFAndIImpOptionSchema.getManageCom();
		makeDate = fDate.getDate(aLNPFAndIImpOptionSchema.getMakeDate());
		makeTime = aLNPFAndIImpOptionSchema.getMakeTime();
		modifyDate = fDate.getDate(aLNPFAndIImpOptionSchema.getModifyDate());
		modifyTime = aLNPFAndIImpOptionSchema.getModifyTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("��ݿ��е�LNPFAndIImpOption���ֶθ����Schema�е��ֶθ���һ�£�����ִ��db.executeQuery��ѯʱû��ʹ��select * from tables");
	...
	{
		LNPFAndIImpOptionSchema aLNPFAndIImpOptionSchema = new LNPFAndIImpOptionSchema();
		aLNPFAndIImpOptionSchema.setSchema(this);
		return aLNPFAndIImpOptionSchema;
	}

	public LNPFAndIImpOptionDB getDB()
	{
		LNPFAndIImpOptionDB aDBOper = new LNPFAndIImpOptionDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		LNPFAndIImpOptionSchema other = (LNPFAndIImpOptionSchema)otherObject;
