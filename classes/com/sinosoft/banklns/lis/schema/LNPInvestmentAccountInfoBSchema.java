...
// Source File Name:   LNPInvestmentAccountInfoBSchema.java
	...
	implements Schema
{
	...
	{
		EdorNo = aLNPInvestmentAccountInfoBSchema.getEdorNo();
		serialNo = aLNPInvestmentAccountInfoBSchema.getserialNo();
		ContNo = aLNPInvestmentAccountInfoBSchema.getContNo();
		RiskCode = aLNPInvestmentAccountInfoBSchema.getRiskCode();
		InvestAccountCode = aLNPInvestmentAccountInfoBSchema.getInvestAccountCode();
		InvestAccountRate = aLNPInvestmentAccountInfoBSchema.getInvestAccountRate();
		Operator = aLNPInvestmentAccountInfoBSchema.getOperator();
		MakeDate = aLNPInvestmentAccountInfoBSchema.getMakeDate();
		MakeTime = aLNPInvestmentAccountInfoBSchema.getMakeTime();
		ModifyDate = aLNPInvestmentAccountInfoBSchema.getModifyDate();
		ModifyTime = aLNPInvestmentAccountInfoBSchema.getModifyTime();
		Remark = aLNPInvestmentAccountInfoBSchema.getRemark();
		Varc1 = aLNPInvestmentAccountInfoBSchema.getVarc1();
		Varc2 = aLNPInvestmentAccountInfoBSchema.getVarc2();
		Varc3 = aLNPInvestmentAccountInfoBSchema.getVarc3();
		Varc4 = aLNPInvestmentAccountInfoBSchema.getVarc4();
		DateTime1 = fDate.getDate(aLNPInvestmentAccountInfoBSchema.getDateTime1());
		DateTime2 = fDate.getDate(aLNPInvestmentAccountInfoBSchema.getDateTime2());
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		catch (SQLException sqle)
		{
			...
			tError.moduleName = "LNPInvestmentAccountInfoBSchema";
	...
	{
		LNPInvestmentAccountInfoBSchema aLNPInvestmentAccountInfoBSchema = new LNPInvestmentAccountInfoBSchema();
		aLNPInvestmentAccountInfoBSchema.setSchema(this);
		return aLNPInvestmentAccountInfoBSchema;
	}

	public LNPInvestmentAccountInfoBDB getDB()
	{
		LNPInvestmentAccountInfoBDB aDBOper = new LNPInvestmentAccountInfoBDB();
	...
	public boolean decode(String strMessage)
	{
		try
		{
			...
			InvestAccountCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, "|");
			InvestAccountRate = (new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 6, "|")))).doubleValue();
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, "|");
			MakeDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, "|");
			MakeTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, "|");
			ModifyDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, "|");
			...
			DateTime1 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, "|"));
			DateTime2 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, "|"));
		}
	...
	public int getFieldIndex(String strFieldName)
	{
		...
		if (strFieldName.equals("DateTime1"))
			return 16;
		return !strFieldName.equals("DateTime2") ? -1 : 17;
	}
