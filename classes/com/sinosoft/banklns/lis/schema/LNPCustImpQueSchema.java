...
// Source File Name:   LNPCustImpQueSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		LNPCustImpQueSchema cloned = (LNPCustImpQueSchema)super.clone();
	...
	{
		impartId = aLNPCustImpQueSchema.getImpartId();
		questionid = aLNPCustImpQueSchema.getQuestionid();
		questionType = aLNPCustImpQueSchema.getQuestionType();
		content1 = aLNPCustImpQueSchema.getContent1();
		content2 = aLNPCustImpQueSchema.getContent2();
		queOrder = aLNPCustImpQueSchema.getQueOrder();
		innerOrder = aLNPCustImpQueSchema.getInnerOrder();
		outQueId = aLNPCustImpQueSchema.getOutQueId();
		innerQueNum = aLNPCustImpQueSchema.getInnerQueNum();
		parentId = aLNPCustImpQueSchema.getParentId();
		childQueNum = aLNPCustImpQueSchema.getChildQueNum();
		operator = aLNPCustImpQueSchema.getOperator();
		manageCom = aLNPCustImpQueSchema.getManageCom();
		makeDate = fDate.getDate(aLNPCustImpQueSchema.getMakeDate());
		makeTime = aLNPCustImpQueSchema.getMakeTime();
		modifyDate = fDate.getDate(aLNPCustImpQueSchema.getModifyDate());
		modifyTime = aLNPCustImpQueSchema.getModifyTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的LNPCustImpQue表字段个数和Schema中的字段个数不一致，或�?�执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "LNPCustImpQueSchema";
	...
	{
		LNPCustImpQueSchema aLNPCustImpQueSchema = new LNPCustImpQueSchema();
		aLNPCustImpQueSchema.setSchema(this);
		return aLNPCustImpQueSchema;
	}

	public LNPCustImpQueDB getDB()
	{
		LNPCustImpQueDB aDBOper = new LNPCustImpQueDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		LNPCustImpQueSchema other = (LNPCustImpQueSchema)otherObject;
