...
// Source File Name:   LNPAgentIImpResultSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		LNPAgentIImpResultSchema cloned = (LNPAgentIImpResultSchema)super.clone();
	...
	{
		resultId = aLNPAgentIImpResultSchema.getResultId();
		grpContNo = aLNPAgentIImpResultSchema.getGrpContNo();
		contNo = aLNPAgentIImpResultSchema.getContNo();
		proposalContNo = aLNPAgentIImpResultSchema.getProposalContNo();
		impartId = aLNPAgentIImpResultSchema.getImpartId();
		grouporder = aLNPAgentIImpResultSchema.getGrouporder();
		qID01 = aLNPAgentIImpResultSchema.getQID01();
		a01 = aLNPAgentIImpResultSchema.getA01();
		qID02 = aLNPAgentIImpResultSchema.getQID02();
		a02 = aLNPAgentIImpResultSchema.getA02();
		qID03 = aLNPAgentIImpResultSchema.getQID03();
		a03 = aLNPAgentIImpResultSchema.getA03();
		qID04 = aLNPAgentIImpResultSchema.getQID04();
		a04 = aLNPAgentIImpResultSchema.getA04();
		qID05 = aLNPAgentIImpResultSchema.getQID05();
		a05 = aLNPAgentIImpResultSchema.getA05();
		qID06 = aLNPAgentIImpResultSchema.getQID06();
		a06 = aLNPAgentIImpResultSchema.getA06();
		operator = aLNPAgentIImpResultSchema.getOperator();
		manageCom = aLNPAgentIImpResultSchema.getManageCom();
		makeDate = fDate.getDate(aLNPAgentIImpResultSchema.getMakeDate());
		makeTime = aLNPAgentIImpResultSchema.getMakeTime();
		modifyDate = fDate.getDate(aLNPAgentIImpResultSchema.getModifyDate());
		modifyTime = aLNPAgentIImpResultSchema.getModifyTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的LNPAgentIImpResult表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "LNPAgentIImpResultSchema";
	...
	{
		LNPAgentIImpResultSchema aLNPAgentIImpResultSchema = new LNPAgentIImpResultSchema();
		aLNPAgentIImpResultSchema.setSchema(this);
		return aLNPAgentIImpResultSchema;
	}

	public LNPAgentIImpResultDB getDB()
	{
		LNPAgentIImpResultDB aDBOper = new LNPAgentIImpResultDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		LNPAgentIImpResultSchema other = (LNPAgentIImpResultSchema)otherObject;
