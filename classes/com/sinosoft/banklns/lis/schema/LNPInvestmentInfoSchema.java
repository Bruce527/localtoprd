...
// Source File Name:   LNPInvestmentInfoSchema.java
	...
	implements Schema
{
	...
	{
		ID = aLNPInvestmentInfoSchema.getID();
		ContNo = aLNPInvestmentInfoSchema.getContNo();
		StockInvestAccount = aLNPInvestmentInfoSchema.getStockInvestAccount();
		MixedStockInvestAccount = aLNPInvestmentInfoSchema.getMixedStockInvestAccount();
		MixedBondInvestAccount = aLNPInvestmentInfoSchema.getMixedBondInvestAccount();
		BondInvestAccount = aLNPInvestmentInfoSchema.getBondInvestAccount();
		CurrencyInvestAccount = aLNPInvestmentInfoSchema.getCurrencyInvestAccount();
		PayExtraPremFlag = aLNPInvestmentInfoSchema.getPayExtraPremFlag();
		MonthPlusPrem = aLNPInvestmentInfoSchema.getMonthPlusPrem();
		TermInvestment = aLNPInvestmentInfoSchema.getTermInvestment();
		HesInvestment = aLNPInvestmentInfoSchema.getHesInvestment();
		Operator = aLNPInvestmentInfoSchema.getOperator();
		MakeDate = aLNPInvestmentInfoSchema.getMakeDate();
		MakeTime = aLNPInvestmentInfoSchema.getMakeTime();
		ModifyDate = aLNPInvestmentInfoSchema.getModifyDate();
		ModifyTime = aLNPInvestmentInfoSchema.getModifyTime();
		Remark = aLNPInvestmentInfoSchema.getRemark();
		Varc1 = aLNPInvestmentInfoSchema.getVarc1();
		Varc2 = aLNPInvestmentInfoSchema.getVarc2();
		Varc3 = aLNPInvestmentInfoSchema.getVarc3();
		Varc4 = aLNPInvestmentInfoSchema.getVarc4();
		DateTime1 = fDate.getDate(aLNPInvestmentInfoSchema.getDateTime1());
		DateTime2 = fDate.getDate(aLNPInvestmentInfoSchema.getDateTime2());
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		catch (SQLException sqle)
		{
			...
			tError.moduleName = "LNPInvestmentInfoSchema";
	...
	{
		LNPInvestmentInfoSchema aLNPInvestmentInfoSchema = new LNPInvestmentInfoSchema();
		aLNPInvestmentInfoSchema.setSchema(this);
		return aLNPInvestmentInfoSchema;
	}

	public LNPInvestmentInfoDB getDB()
	{
		LNPInvestmentInfoDB aDBOper = new LNPInvestmentInfoDB();
	...
	public boolean decode(String strMessage)
	{
		try
		{
			...
			StockInvestAccount = (new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 3, "|")))).doubleValue();
			MixedStockInvestAccount = (new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 4, "|")))).doubleValue();
			MixedBondInvestAccount = (new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 5, "|")))).doubleValue();
			BondInvestAccount = (new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 6, "|")))).doubleValue();
			CurrencyInvestAccount = (new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 7, "|")))).doubleValue();
			PayExtraPremFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, "|");
			MonthPlusPrem = (new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 9, "|")))).doubleValue();
			TermInvestment = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, "|");
			HesInvestment = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, "|");
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, "|");
			MakeDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, "|");
			MakeTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, "|");
			ModifyDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, "|");
			ModifyTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, "|");
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, "|");
			Varc1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, "|");
			Varc2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, "|");
			Varc3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, "|");
			Varc4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, "|");
			DateTime1 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, "|"));
			DateTime2 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, "|"));
		}
	...
	public int getFieldIndex(String strFieldName)
	{
		...
		if (strFieldName.equals("DateTime1"))
			return 21;
		return !strFieldName.equals("DateTime2") ? -1 : 22;
	}
