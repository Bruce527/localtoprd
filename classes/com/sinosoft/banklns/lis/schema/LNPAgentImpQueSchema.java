...
// Source File Name:   LNPAgentImpQueSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		LNPAgentImpQueSchema cloned = (LNPAgentImpQueSchema)super.clone();
	...
	{
		impartId = aLNPAgentImpQueSchema.getImpartId();
		questionid = aLNPAgentImpQueSchema.getQuestionid();
		questionType = aLNPAgentImpQueSchema.getQuestionType();
		content1 = aLNPAgentImpQueSchema.getContent1();
		content2 = aLNPAgentImpQueSchema.getContent2();
		queOrder = aLNPAgentImpQueSchema.getQueOrder();
		innerOrder = aLNPAgentImpQueSchema.getInnerOrder();
		outQueId = aLNPAgentImpQueSchema.getOutQueId();
		innerQueNum = aLNPAgentImpQueSchema.getInnerQueNum();
		parentId = aLNPAgentImpQueSchema.getParentId();
		childQueNum = aLNPAgentImpQueSchema.getChildQueNum();
		operator = aLNPAgentImpQueSchema.getOperator();
		manageCom = aLNPAgentImpQueSchema.getManageCom();
		makeDate = fDate.getDate(aLNPAgentImpQueSchema.getMakeDate());
		makeTime = aLNPAgentImpQueSchema.getMakeTime();
		modifyDate = fDate.getDate(aLNPAgentImpQueSchema.getModifyDate());
		modifyTime = aLNPAgentImpQueSchema.getModifyTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的LNPAgentImpQue表字段个数和Schema中的字段个数不一致，或�?�执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "LNPAgentImpQueSchema";
	...
	{
		LNPAgentImpQueSchema aLNPAgentImpQueSchema = new LNPAgentImpQueSchema();
		aLNPAgentImpQueSchema.setSchema(this);
		return aLNPAgentImpQueSchema;
	}

	public LNPAgentImpQueDB getDB()
	{
		LNPAgentImpQueDB aDBOper = new LNPAgentImpQueDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		LNPAgentImpQueSchema other = (LNPAgentImpQueSchema)otherObject;
