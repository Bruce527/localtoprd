...
// Source File Name:   LNPAgentImpOptionSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		LNPAgentImpOptionSchema cloned = (LNPAgentImpOptionSchema)super.clone();
	...
	{
		impartId = aLNPAgentImpOptionSchema.getImpartId();
		questionId = aLNPAgentImpOptionSchema.getQuestionId();
		optionId = aLNPAgentImpOptionSchema.getOptionId();
		optionOrder = aLNPAgentImpOptionSchema.getOptionOrder();
		optionContent = aLNPAgentImpOptionSchema.getOptionContent();
		operator = aLNPAgentImpOptionSchema.getOperator();
		manageCom = aLNPAgentImpOptionSchema.getManageCom();
		makeDate = fDate.getDate(aLNPAgentImpOptionSchema.getMakeDate());
		makeTime = aLNPAgentImpOptionSchema.getMakeTime();
		modifyDate = fDate.getDate(aLNPAgentImpOptionSchema.getModifyDate());
		modifyTime = aLNPAgentImpOptionSchema.getModifyTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的LNPAgentImpOption表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "LNPAgentImpOptionSchema";
	...
	{
		LNPAgentImpOptionSchema aLNPAgentImpOptionSchema = new LNPAgentImpOptionSchema();
		aLNPAgentImpOptionSchema.setSchema(this);
		return aLNPAgentImpOptionSchema;
	}

	public LNPAgentImpOptionDB getDB()
	{
		LNPAgentImpOptionDB aDBOper = new LNPAgentImpOptionDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		LNPAgentImpOptionSchema other = (LNPAgentImpOptionSchema)otherObject;
