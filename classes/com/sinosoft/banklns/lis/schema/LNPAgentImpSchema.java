...
// Source File Name:   LNPAgentImpSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		LNPAgentImpSchema cloned = (LNPAgentImpSchema)super.clone();
	...
	{
		impartId = aLNPAgentImpSchema.getImpartId();
		impartName = aLNPAgentImpSchema.getImpartName();
		impartVer = aLNPAgentImpSchema.getImpartVer();
		impartContent = aLNPAgentImpSchema.getImpartContent();
		questionSum = aLNPAgentImpSchema.getQuestionSum();
		operator = aLNPAgentImpSchema.getOperator();
		manageCom = aLNPAgentImpSchema.getManageCom();
		makeTime = aLNPAgentImpSchema.getMakeTime();
		makeDate = fDate.getDate(aLNPAgentImpSchema.getMakeDate());
		modifyDate = fDate.getDate(aLNPAgentImpSchema.getModifyDate());
		modifyTime = aLNPAgentImpSchema.getModifyTime();
		p1 = aLNPAgentImpSchema.getP1();
		p2 = aLNPAgentImpSchema.getP2();
		p3 = aLNPAgentImpSchema.getP3();
		p4 = aLNPAgentImpSchema.getP4();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的LNPAgentImp表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "LNPAgentImpSchema";
	...
	{
		LNPAgentImpSchema aLNPAgentImpSchema = new LNPAgentImpSchema();
		aLNPAgentImpSchema.setSchema(this);
		return aLNPAgentImpSchema;
	}

	public LNPAgentImpDB getDB()
	{
		LNPAgentImpDB aDBOper = new LNPAgentImpDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		LNPAgentImpSchema other = (LNPAgentImpSchema)otherObject;
