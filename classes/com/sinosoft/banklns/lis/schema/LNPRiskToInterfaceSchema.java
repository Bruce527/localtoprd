...
// Source File Name:   LNPRiskToInterfaceSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		LNPRiskToInterfaceSchema cloned = (LNPRiskToInterfaceSchema)super.clone();
	...
	{
		codeType = aLNPRiskToInterfaceSchema.getCodeType();
		code = aLNPRiskToInterfaceSchema.getCode();
		codeName = aLNPRiskToInterfaceSchema.getCodeName();
		codeAlias = aLNPRiskToInterfaceSchema.getCodeAlias();
		codeBak = aLNPRiskToInterfaceSchema.getCodeBak();
		otherSign = aLNPRiskToInterfaceSchema.getOtherSign();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		try
		{
			...
			if (rs.getString("CodeBak") == null)
				codeBak = null;
			else
				codeBak = rs.getString("CodeBak").trim();
		...
		{
			System.out.println("��ݿ��е�LNPRiskToInterface���ֶθ����Schema�е��ֶθ���һ�£�����ִ��db.executeQuery��ѯʱû��ʹ��select * from tables");
			CError tError = new CError();
			tError.moduleName = "LNPRiskToInterfaceSchema";
	...
	{
		LNPRiskToInterfaceSchema aLNPRiskToInterfaceSchema = new LNPRiskToInterfaceSchema();
		aLNPRiskToInterfaceSchema.setSchema(this);
		return aLNPRiskToInterfaceSchema;
	}

	public LNPRiskToInterfaceDB getDB()
	{
		LNPRiskToInterfaceDB aDBOper = new LNPRiskToInterfaceDB();
	...
	public String encode()
	{
		...
		strReturn.append("|");
		strReturn.append(StrTool.cTrim(codeBak));
		strReturn.append("|");
	...
	public boolean decode(String strMessage)
	{
		try
		{
			...
			codeBak = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, "|");
	...
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("codeBak"))
			strReturn = StrTool.GBKToUnicode(String.valueOf(codeBak));
	...
	public String getV(int nFieldIndex)
	{
		...
		case 4: // '\004'
			strFieldValue = StrTool.GBKToUnicode(codeBak);
			break;
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		LNPRiskToInterfaceSchema other = (LNPRiskToInterfaceSchema)otherObject;
		...
		if (codeAlias != null && !codeAlias.equals(other.getCodeAlias()))
			return false;
		if (codeBak == null && other.getCodeBak() != null)
			return false;
		if (codeBak != null && !codeBak.equals(other.getCodeBak()))
			return false;
	...
	public int getFieldIndex(String strFieldName)
	{
		...
		if (strFieldName.equals("codeAlias"))
			return 3;
		if (strFieldName.equals("codeBak"))
			return 4;
