...
// Source File Name:   LNPCustImpOptionSchema.java
	...
	implements Schema, Cloneable
{
	...
	{
		LNPCustImpOptionSchema cloned = (LNPCustImpOptionSchema)super.clone();
	...
	{
		impartId = aLNPCustImpOptionSchema.getImpartId();
		questionId = aLNPCustImpOptionSchema.getQuestionId();
		optionId = aLNPCustImpOptionSchema.getOptionId();
		optionOrder = aLNPCustImpOptionSchema.getOptionOrder();
		optionContent = aLNPCustImpOptionSchema.getOptionContent();
		operator = aLNPCustImpOptionSchema.getOperator();
		manageCom = aLNPCustImpOptionSchema.getManageCom();
		makeDate = fDate.getDate(aLNPCustImpOptionSchema.getMakeDate());
		makeTime = aLNPCustImpOptionSchema.getMakeTime();
		modifyDate = fDate.getDate(aLNPCustImpOptionSchema.getModifyDate());
		modifyTime = aLNPCustImpOptionSchema.getModifyTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			System.out.println("数据库中的LNPCustImpOption表字段个数和Schema中的字段个数不一致，或�?�执行db.executeQuery查询时没有使用select * from tables");
			CError tError = new CError();
			tError.moduleName = "LNPCustImpOptionSchema";
	...
	{
		LNPCustImpOptionSchema aLNPCustImpOptionSchema = new LNPCustImpOptionSchema();
		aLNPCustImpOptionSchema.setSchema(this);
		return aLNPCustImpOptionSchema;
	}

	public LNPCustImpOptionDB getDB()
	{
		LNPCustImpOptionDB aDBOper = new LNPCustImpOptionDB();
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		LNPCustImpOptionSchema other = (LNPCustImpOptionSchema)otherObject;
