...
// Source File Name:   LNPPaymentSchema.java
	...
	implements Schema
{
	...
	{
		ContNo = aLNPPaymentSchema.getContNo();
		AppntID = aLNPPaymentSchema.getAppntID();
		InusredID = aLNPPaymentSchema.getInusredID();
		PayMent1 = aLNPPaymentSchema.getPayMent1();
		PayMent2 = aLNPPaymentSchema.getPayMent2();
		BankCode = aLNPPaymentSchema.getBankCode();
		Account = aLNPPaymentSchema.getAccount();
		Operator = aLNPPaymentSchema.getOperator();
		MakeDate = fDate.getDate(aLNPPaymentSchema.getMakeDate());
		MakeTime = aLNPPaymentSchema.getMakeTime();
		ModifyDate = fDate.getDate(aLNPPaymentSchema.getModifyDate());
		ModifyTime = aLNPPaymentSchema.getModifyTime();
		Varc1 = aLNPPaymentSchema.getVarc1();
		Varc2 = aLNPPaymentSchema.getVarc2();
		Varc3 = aLNPPaymentSchema.getVarc3();
		Varc4 = aLNPPaymentSchema.getVarc4();
		DateTime1 = fDate.getDate(aLNPPaymentSchema.getDateTime1());
		DateTime2 = fDate.getDate(aLNPPaymentSchema.getDateTime2());
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		catch (SQLException sqle)
		{
			...
			tError.moduleName = "LNPPaymentSchema";
	...
	{
		LNPPaymentSchema aLNPPaymentSchema = new LNPPaymentSchema();
		aLNPPaymentSchema.setSchema(this);
		return aLNPPaymentSchema;
	}

	public LNPPaymentDB getDB()
	{
		LNPPaymentDB aDBOper = new LNPPaymentDB();
	...
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AppntID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, "|");
			InusredID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, "|");
			PayMent1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, "|");
			PayMent2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, "|");
			BankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, "|");
			Account = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, "|");
			...
			ModifyDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, "|"));
