...
// Source File Name:   CRSInfoSet.java
...
public class CRSInfoSet extends SchemaSet
{
	...
	{
		CRSInfoSchema tSchema = (CRSInfoSchema)super.getObj(index);
		return tSchema;
	}
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			CRSInfoSchema aSchema = new CRSInfoSchema();
		...
		CRSInfoSchema tSchema = new CRSInfoSchema();
