...
// Source File Name:   LNPInsuredBSet.java
...
public class LNPInsuredBSet extends SchemaSet
{
	...
	{
		LNPInsuredBSchema tSchema = (LNPInsuredBSchema)super.getObj(index);
		return tSchema;
	}
	...
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			LNPInsuredBSchema aSchema = get(i);
	...
	public boolean decode(String str)
	{
		...
		LNPInsuredBSchema tSchema = new LNPInsuredBSchema();
