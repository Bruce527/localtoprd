...
// Source File Name:   LNPAddressBSet.java
...
public class LNPAddressBSet extends SchemaSet
{
	...
	{
		LNPAddressBSchema tSchema = (LNPAddressBSchema)super.getObj(index);
		return tSchema;
	}
	...
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			LNPAddressBSchema aSchema = get(i);
	...
	public boolean decode(String str)
	{
		...
		{
			LNPAddressBSchema aSchema = new LNPAddressBSchema();
		...
		LNPAddressBSchema tSchema = new LNPAddressBSchema();
