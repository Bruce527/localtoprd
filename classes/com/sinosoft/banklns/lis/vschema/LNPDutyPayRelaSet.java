...
// Source File Name:   LNPDutyPayRelaSet.java
...
public class LNPDutyPayRelaSet extends SchemaSet
{
	...
	{
		LNPDutyPayRelaSchema tSchema = (LNPDutyPayRelaSchema)super.getObj(index);
		return tSchema;
	}
	...
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			LNPDutyPayRelaSchema aSchema = get(i);
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			LNPDutyPayRelaSchema aSchema = new LNPDutyPayRelaSchema();
		...
		LNPDutyPayRelaSchema tSchema = new LNPDutyPayRelaSchema();
