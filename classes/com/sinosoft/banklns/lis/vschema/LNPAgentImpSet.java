...
// Source File Name:   LNPAgentImpSet.java
...
public class LNPAgentImpSet extends SchemaSet
{
	...
	{
		LNPAgentImpSchema tSchema = (LNPAgentImpSchema)super.getObj(index);
		return tSchema;
	}
	...
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			LNPAgentImpSchema aSchema = get(i);
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			LNPAgentImpSchema aSchema = new LNPAgentImpSchema();
		...
		LNPAgentImpSchema tSchema = new LNPAgentImpSchema();
