...
// Source File Name:   LNPRiskComCtrlSet.java
...
public class LNPRiskComCtrlSet extends SchemaSet
{
	...
	{
		LNPRiskComCtrlSchema tSchema = (LNPRiskComCtrlSchema)super.getObj(index);
		return tSchema;
	}
	...
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			LNPRiskComCtrlSchema aSchema = get(i);
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			LNPRiskComCtrlSchema aSchema = new LNPRiskComCtrlSchema();
		...
		LNPRiskComCtrlSchema tSchema = new LNPRiskComCtrlSchema();
