...
// Source File Name:   LNPRiskSaleGroupToRiskSet.java
...
public class LNPRiskSaleGroupToRiskSet extends SchemaSet
{
	...
	public LNPRiskSaleGroupToRiskSet()
	{
	}
	...
	{
		LNPRiskSaleGroupToRiskSchema tSchema = (LNPRiskSaleGroupToRiskSchema)super.getObj(index);
		return tSchema;
	}
	...
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			LNPRiskSaleGroupToRiskSchema aSchema = get(i);
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			LNPRiskSaleGroupToRiskSchema aSchema = new LNPRiskSaleGroupToRiskSchema();
		...
		LNPRiskSaleGroupToRiskSchema tSchema = new LNPRiskSaleGroupToRiskSchema();
