...
// Source File Name:   LNPAgentImpResultSet.java
...
public class LNPAgentImpResultSet extends SchemaSet
{
	...
	{
		LNPAgentImpResultSchema tSchema = (LNPAgentImpResultSchema)super.getObj(index);
		return tSchema;
	}
	...
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			LNPAgentImpResultSchema aSchema = get(i);
	...
	public boolean decode(String str)
	{
		...
		while (nEndPos != -1) 
		{
			LNPAgentImpResultSchema aSchema = new LNPAgentImpResultSchema();
		...
		LNPAgentImpResultSchema tSchema = new LNPAgentImpResultSchema();
