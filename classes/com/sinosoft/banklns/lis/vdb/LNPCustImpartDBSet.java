...
// Source File Name:   LNPCustImpartDBSet.java
...
public class LNPCustImpartDBSet extends LNPCustImpartSet
{
	...
	public boolean deleteSQL()
	{
		...
		} else
		{
			...
			tError.moduleName = "LNPCustImpartDBSet";
		...
		try
		{
			...
			for (int i = 1; i <= tCount; i++)
			{
				...
				if (get(i).getModifyDate() == null || get(i).getModifyDate().equals("null"))
					...
					pstmt.setDate(11, Date.valueOf(get(i).getModifyDate()));
				if (get(i).getModifyTime() == null || get(i).getModifyTime().equals("null"))
					pstmt.setString(12, null);
				else
					pstmt.setString(12, get(i).getModifyTime());
				if (get(i).getP1() == null || get(i).getP1().equals("null"))
					pstmt.setString(13, null);
				else
					pstmt.setString(13, get(i).getP1());
				...
				if (get(i).getP3() == null || get(i).getP3().equals("null"))
					...
					pstmt.setString(15, get(i).getP3());
				...
				if (get(i).getImpartId() == null || get(i).getImpartId().equals("null"))
					...
					pstmt.setString(17, get(i).getImpartId());
				pstmt.addBatch();
			}
