...
public class SQLString
{
	...
	{
		System.out.println((new StringBuilder("MDESSql is : ")).append(mSql.toString()).toString());
	...
	public String getSQL(int sqlFlag, Schema s)
	{
		if (sqlFlag == 5 || sqlFlag == 6)
			...
			mSql.setLength(0);
		System.out.println((new StringBuilder("MDES Sql: ")).append(mSql.toString()).toString());
		return mSql.toString();
	}
	...
	public void setPKWherePart(Schema s)
	{
		...
		for (int i = 0; i < n; i++)
		{
			...
			default:
				System.out.println("ï¿½ï¿½ï¿½ï¿½ï¿½ì³£ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿?");
				break;
			}
			if (i != 0)
