	...
	implements ESBWebEntrySoap_PortType
{
		...
		throws RemoteException
	{
		...
		_call = createCall();
		_call.setTimeout(Integer.valueOf(0x927c0));
		System.out.println((new StringBuilder("--------->EAI soap_bin timeOut is :")).append(_call.getTimeout().intValue() / 60000).append(" min").toString());
		...
		System.out.println((new StringBuilder("--SOAP Request: ")).append(_call.getMessageContext().getRequestMessage().getSOAPPartAsString()).toString());
		System.out.println((new StringBuilder("--SOAP Response: ")).append(_call.getResponseMessage().getSOAPPartAsString()).toString());
